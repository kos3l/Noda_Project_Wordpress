...
function Noda_enqueue_styles() {
   ...
   /*  if($post->post_name == "index") {
    ...
    if( is_page() || is_single() )
    {
        ...
        {
            case 'services':
                wp_enqueue_script('about', get_template_directory_uri() . '/js/forside.js', array('jquery'), '', false);
                break;
            case 'om-os':
                wp_enqueue_script('anim-os', get_template_directory_uri() . '/js/om_os.js', array('jquery'), '', true);
                break;
            case 'kontakt':
                wp_enqueue_script('anim-kont', get_template_directory_uri() . '/js/somepost.js', array('jquery'), '1.6', true);
                break;
        }
    } 
