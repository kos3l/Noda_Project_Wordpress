...
function Noda_enqueue_styles() {
    ...
    wp_enqueue_script("scroll-trigger", "https://cdnjs.cloudflare.com/ajax/libs/gsap/3.8.0/ScrollTrigger.min.js");
    wp_enqueue_script("scroll-trigger", "https://cdnjs.cloudflare.com/ajax/libs/gsap/3.8.0/gsap.min.js");
