...
<div class="container-fluid setup-bg d-flex flex-column intro-test mt-4 mb-4  trigger-test-2 ">
  <div class="container my-auto">
    ...
    <div class="row button-row justify-content-between text-center mt-5">
