...
function Noda_enqueue_styles() {
   ...
   /*  if($post->post_name == "index") {
    ...
    if( is_page() || is_single() )
    {
        ...
        {
            case 'services':
                wp_enqueue_script('', get_template_directory_uri() . '/js/forside.js', array('jquery'), '', false);
                break;
            case '/':
                wp_enqueue_script('anim-forside', get_template_directory_uri() . '/js/om_os.js', array('jquery'), '', true);
                break;
            case 'kontakt':
