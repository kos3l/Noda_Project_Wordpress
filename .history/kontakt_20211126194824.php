               ...
               <div class="col-12 col-md-5 col-lg-5 info-bg">
                        <div class="info-wrapper pt-5 px-5">
                            ...
                            <div class="row d-flex flex-column px-5">
                                <div class="col-12 col-md-4"><i class="fa fa-map"></i><h3>Adress</h3></div>
                                <div class="col-12 col-md-4"><i class="fa fa-phone"></i><h3>Phone</h3></div>
                                <div class="col-12 col-md-4"><i class="fa fa-envelope></i><h3>Email</h3></div>
                            </div>
                        </div>
               </div>
           </div>
