 ...
 <div class="container mt-5">
    <div class="row">
        ...
        <div class="col px-0 pt-5 mx-0  ">
            <h2 class=" serviceLink">DISCOVER ALL OUR SERVICES</h2>
        </div>
    </div>
            </div>
  ...
  <div class="row main-body projects  p-md-5 mx-0 ">
        ...
        <div class="col-12">
          ...
          <div class="galleri-show">
              <?php echo do_shortcode('[ngg src="galleries" ids="3" display="basic_thumbnail" thumbnail_crop="0" images_per_page="3" ajax_pagination="0"]') ?>
          </div>
        </div>
    </div>
  </div>
    ...
    <div class="row main-body location   mx-0 mb-5 ">
        <div class="col-12 col-sm-6 p-md-5 d-flex flex-column justify-content-center align-items-center ">
