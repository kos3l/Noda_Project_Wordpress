...
<!-- <div class="container-fluid intro-test mt-5 pb-3">
    <div class="container mt-5 pb-2 mx-0 text-center">
        <div class="text">
            <h2>QUALITY FIRST</h2>
        </div>
    <div class="row main-body">
       <div class="col-12 d-flex justify-content-evenly">
            <div class="wrapper-footer-body text-center">
                <h3>Design</h3>
        ...
        <div class="col-4">
        <div class="wrapper-test-body text-center">
                <h3>Design</h3>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Optio, recusandae.</p>
            </div>
        </div>
...
<div class="container-fluid setup-bg d-flex flex-column intro-test mt-5 mb-5">
  <div class="container my-auto">
    <h3 class="h3 white my-5 text-center text">
      Quality and price is always what matters the most 
      <br> Click the social media icons to add them to your bar</h3>
    <div class="row button-row justify-content-between text-center">
      <div class="col-4 col-sm-3 col-md-3">
                    <span style="font-size: 2.5em; color: #ffffff;  "> <i class="fas fa-toolbox"></i> </span>
                   <div class="testos" style="color:#ffffff;">
