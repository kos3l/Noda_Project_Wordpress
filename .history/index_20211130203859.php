...
<div class="container mt-5 mb-5 block-padding">
           ...
           <div class="row">
               ...
               <div class="button-wrapper">
                         <button class="contactBtn p-4">
                            <a class="effect effect-1" href="#" title="Learn More">KONTAKT OS</a>
                        </button>
 ...
 <div class="container mt-5 block-padding ">
    <div class="row ">
        <div class="col-12 col-md-6 col-lg-6 trigger-picture">
...
<div class="container-fluid setup-bg d-flex flex-column intro-test mt-4 mb-4  ">
  <div class="container my-auto  trigger-test-2">
