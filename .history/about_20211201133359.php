    ...
    <div class="row  pt-5 block-padding">
        ...
        <div class="col-12 col-md-6 d-flex justify-content-md-end">
            <div class="description text-end">
                <h2><?php the_field("om_os_beskrivelse"); ?></h2>
            </div>
        </div>
    </div>
</div>
...
<div class="container mt-5 ">
    <div class="row block-padding">
        ...
        <div class="om-os-image-wrapper mascot-slide ">
...
<div class="container  mb-5">
    <div class="row block-padding ">
        ...
        <div class="om-os-image-wrapper mt-5 first-owner-pic-slide ">
                <img src="<?php the_field("om_os_første_billede")?>" width="100%" alt="">
                </div>
        </div>
        ...
        <div class="om-us-wrapper ">
            ...
            <div class="om-us-paragraph owner-trigger ">
                <p>
