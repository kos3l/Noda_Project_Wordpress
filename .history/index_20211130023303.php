 ...
 <div class="container mt-5 block-padding">
    <div class="row">
        ...
        <div class="service-main-image-wrapper text-center  ">
                <img scroll src="https://images.unsplash.com/photo-1618090584176-7132b9911657?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8YnVpbGRlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" width="100%" alt="">
                </div>
        </div>
    </div>
</div>
