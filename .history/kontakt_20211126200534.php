               ...
               <div class="col-12 col-md-5 col-lg-5 info-bg">
                        <div class="info-wrapper pt-5 px-5">
                            ...
                            <div class="row d-flex flex-column p-5 info-row">
                                <div class="col-12 col-md-12 inherit pt-5">
                                    <div class="info-sub">
                                    <i class="fa fa-map"></i><h3>Violvænget 3 , Thurø, 5700 Svendborg</h3>
                                    </div>
                                   
                                </div>
                                <div class="col-12 col-md-12 inherit py-4">
                                    <div class="info-sub">
                                    <i class="fa fa-phone"></i><h3>(+45) 21 80 00 91</h3>
                                    </div>
