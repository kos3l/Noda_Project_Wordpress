 ...
 <div class="container mt-5 block-padding">
    <div class="row">
        ...
        <div class="service-main-image-wrapper text-center  ">
                <img  src="https://images.unsplash.com/photo-1618090584176-7132b9911657?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8YnVpbGRlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" width="100%" alt="" class="scroll">
                </div>
        </div>
    </div>
</div>
...
<div class="row main-body   pt-5 pb-2 mx-0 ">
    <div class="main-title text-center  ">
        ...
        <div class="col-12 col-lg-6 mb-4 mt-4">
            <div class="picture-wrapper-main scroll">
