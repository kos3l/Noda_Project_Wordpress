...
<div class="container-fluid info-background trigger-test-2 ">
   ...
   <div class="container-fluid form-background mb-3">
       <div class="container pt-5">
           <div class="row form-shaddow">
               ...
               <div class="col-12 col-md-5 col-lg-5 info-bg each-scroll-pop ">
                        <div class="info-wrapper pt-5 px-5  mb-3">
                            ...
                            <div class="row d-flex flex-column pt-3 info-row">
                                ...
                                <div class="col-12 col-md-12 inherit  pt-md-5 each-scroll-pop">
